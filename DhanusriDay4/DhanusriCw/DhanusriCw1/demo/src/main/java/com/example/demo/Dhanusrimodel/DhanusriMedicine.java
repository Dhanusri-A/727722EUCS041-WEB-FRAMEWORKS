...
public class DhanusriMedicine {
     ...
     public DhanusriMedicine() {

     }

     public DhanusriMedicine(int medicineId, String medicineName, String medicineFor, String medicineBrand,
