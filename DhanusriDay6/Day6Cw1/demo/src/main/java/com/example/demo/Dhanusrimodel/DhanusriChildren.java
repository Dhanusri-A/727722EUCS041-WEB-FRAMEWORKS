...
public class DhanusriChildren {
     ...
     public DhanusriChildren() {

     }

     public DhanusriChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
