...
public class DhanusriCourse {
     ...
     public DhanusriCourse() {

     }

     public DhanusriCourse(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
